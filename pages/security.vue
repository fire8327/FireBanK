<template>
    <div class="flex p-3.5 md:p-10 xl:p-12 rounded-xl relative lg:justify-end bg-[#1C1C1C] max-lg:flex-col">
        ...
        <img src="/images/security/hero.png" alt="" class="rounded-[20px] relative z-[1]">
        <div class="lg:absolute lg:top-[39px] lg:left-[39px] xl:top-[47px] xl:left-[47px] p-6 md:p-14 xl:p-20 flex flex-col gap-3.5 md:gap-5 xl:gap-6 bg-[#1A1A1A] max-lg:rounded-[20px] max-lg:-mt-6 lg:w-1/2 lg:rounded-l-[20px] lg:rounded-br-[60px] xl:rounded-br-[80px] z-[2]">
            <p class="text-3xl md:text-5xl xl:text-6xl font-medium leading-[130%] text-white">Your Security is Our <span class="text-[#CAFF33]">Top Priority</span></p>
            <p class="text-sm md:text-base xl:text-lg leading-[150%] text-[#B3B3B3]">At FireBanK, we understand the importance of keeping your financial information secure. We employ robust security measures and advanced technologies to protect your personal and financial data. Rest assured that when you bank with us, your security is our utmost priority.</p>   
        </div>   
    </div>
    <div class="flex flex-col gap-10 md:gap-14 xl:gap-20 text-white">
        <div class="flex flex-col gap-2 md:gap-2.5 xl:gap-3">
            <p class="text-2xl md:text-4xl xl:text-5xl font-medium leading-[150%]">How We <span class="text-[#CAFF33]">Protect You</span></p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 xl:gap-7">
            ...
            <div class="flex flex-col gap-5 xl:gap-7 rounded-xl p-4 md:p-10 xl:p-12 bg-[#1C1C1C] border border-[#262626] relative overflow-hidden">
                ...
                <p class="text-sm md:text-base xl:text-lg leading-[150%] font-light text-[#B3B3B3] relative z-[1]">Our mobile banking app is designed with the same level of security as our online banking platform. You can confidently access your accounts, make transactions, and manage your finances on the go, knowing that your information is protected.</p>
            </div>
        </div>
    </div>
</template>
